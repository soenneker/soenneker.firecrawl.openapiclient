...
{
    /// <summary>
    /// Builds and executes requests for operations under \agent\{jobId}
    /// </summary>
    ...
    public partial class WithJobItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithJobItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/agent/{jobId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Firecrawl.OpenApiClient.Agent.Item.WithJobItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithJobItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/agent/{jobId}", rawUrl)
        {
        }
        /// <summary>
        /// Cancel an agent job
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Firecrawl.OpenApiClient.Agent.Item.WithJobItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Firecrawl.OpenApiClient.Agent.Item.WithJobItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
